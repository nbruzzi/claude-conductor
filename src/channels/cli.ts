...
const KINDS_HELP =
  ...
  "  live-delta— sibling-onboarding scope-assignment from active peer (L152). Trust the SHAPE; primary-source-verify any cited SHA/PR/path. Body: JSON conforming to LiveDeltaBody (see src/channels/live-delta.ts).\n" +
  "\n" +
