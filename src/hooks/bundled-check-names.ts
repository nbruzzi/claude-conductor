...
/**
 * Source-of-truth for the 25 generic discipline-as-code checks the plugin
 * bundles, organized by hook event.
 *
 * Two derived shapes:
 * - `BundledCheckName` — closed string-literal union of all 25 names.
 ...
 * length-pinned (=25) + bidirectional set-equality between this map and the
 ...
 * meta-test). The 25 names here pin the plugin copy; if dotfiles canonical
 * adds a 26th bundled check before batch-5 closure, the plugin copy stays
