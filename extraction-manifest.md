...
### Hooks/checks — handoff invariants (substrate-canonical Cluster 4 INVERSIONS arc 2026-05-07)

| File                                                                 | Decision                                                  | Rationale                                                                                                                                         |
| -------------------------------------------------------------------- | --------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------- |
| `~/.claude-dotfiles/src/hooks/checks/handoff-latest-guard.ts`        | substrate-canonical (Cluster 4 INVERSIONS arc 2026-05-07) | Stop-time check that verifies `~/.claude/handoffs/LATEST.md` symlink integrity. Substrate-canonical post-Cluster-4.                               |
| `~/.claude-dotfiles/src/hooks/checks/handoff-symlink-write-guard.ts` | substrate-canonical (Cluster 4 INVERSIONS arc 2026-05-07) | Pre-tool-use Edit/Write block on symlinked paths under `~/.claude/handoffs/`; prevents write-through clobber. Substrate-canonical post-Cluster-4. |

### Hooks/checks — config-protection (substrate-canonical Cluster 5 INVERSIONS arc 2026-05-07; ARC COMPLETE 21/21)

| File                                                             | Decision                                                  | Rationale                                                                                                                                                                    |
| ---------------------------------------------------------------- | --------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `~/.claude-dotfiles/src/hooks/checks/config-protection.ts`       | substrate-canonical (Cluster 5 INVERSIONS arc 2026-05-07) | Config-file write-protection gate; approval-aware mechanism via `/approve-config-edit` slash command. Within-session HOME-derived state. Substrate-canonical post-Cluster-5. |
| `~/.claude-dotfiles/src/hooks/checks/config-protection-cli.ts`   | substrate-canonical (Cluster 5 INVERSIONS arc 2026-05-07) | CLI for config-protection approval markers (executable via `/approve-config-edit` slash command). Within-session approval workflow. Substrate-canonical post-Cluster-5.      |
| `~/.claude-dotfiles/src/hooks/checks/config-protection-store.ts` | substrate-canonical (Cluster 5 INVERSIONS arc 2026-05-07) | Approval marker storage primitives consumed by config-protection.ts + config-protection-cli.ts. Substrate-canonical post-Cluster-5.                                          |
